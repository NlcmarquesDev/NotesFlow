...
<div class="my-5">
    ...
    <div class="d-flex justify-content-center px-0 gap-2 mt-3 row  ">
        ...
        <?php if (!isset($alert)) : ?>
            ...
            <?php endif ?>
        <?php else : ?>
            <div class="alert alert-danger mt-3 d-flex justify-content-center align-items-center gap-3">

                <h4><?= $alert; ?></h4>
                <a href="/notes_app_php/notes" class="btn btn-outline-success">All Notes</a>
            </div>
        <?php endif ?>
